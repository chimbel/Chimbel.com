        ...
        checkForParallax: function(a, e) {
            ...
            if (!f.done) {
                ...
                "3D" != f.type && "3d" != f.type || (punchgs.TweenLite.set(e.c, {
                    ...
                    b = "on" == b ? 1 : b, void 0 !== b && "off" !== b && (f.bgcontainepush(a), f.bgcontainer_depths.push(e.parallax.levels[parseInt(b, 0) - 1] / 100))
                });
                for (var h = 1; h <= f.levels.length; h++) e.c.find(".rs-parallaxlevel-" + h).each(function() {
                    var a = jQuery(this),
                        b = a.closest(".tp-parallax-wrap");
                    b.data("parallaxlevel", f.levels[h - 1]), b.addClass("tp-parallax-container"), f.pcontainepush(b), f.pcontainer_depths.push(f.levels[h - 1])
                });
                "mouse" != f.type && "scroll+mouse" != f.type && "mouse+scroll" != f.type && "3D" != f.type && "3d" != f.type || (a.mouseenter(function(b) {
                    ...
                    for (var n = 0; n < f.pcontainelength; n++) {
                ...
                void 0 !== i.layers && 0 === i.layelength && (i.layers = !1), void 0 !== i.bgs && 0 === i.bgs.length && (i.bgs = !1), b.scrollTicker(e, a)
            }
        },
        ...
        scrollHandling: function(a, d) {
            ...
            if ("3d" != h.type && "3D" != h.type) {
                if (("scroll" == h.type || "scroll+mouse" == h.type || "mouse+scroll" == h.type) && h.pcontainers)
                    for (var k = 0; k < h.pcontainelength; k++)
                ...
                if (h.bgcontainers)
                    for (var k = 0; k < h.bgcontainelength; k++) {
