...
! function(e, t, n) {
    ...
    function i() {
        ...
        for (var l in S)
            if (S.hasOwnProperty(l)) {
                ...
                for (i = r(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++) a = e[o], s = a.split("."), 1 === s.length ? Modernizr[s[0]] = i : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), Modernizr[s[0]][s[1]] = i), b.push((i ? "" : "no-") + s.join("-"))
            }
    }
    ...
    function o(e) {
        ...
        if (N && (t = t.baseVal), Modernizr._config.enableJSClass) {
            var r = new RegExp("(^|\\s)" + n + "no-js(\\s|$)");
            t = t.replace(r, "$1" + n + "js$2")
        }
        Modernizr._config.enableClasses && (t += " " + n + e.join(" " + n), N ? _.className.baseVal = t : _.className = t)
    }

    function a(e, t) {
        if ("object" == typeof e)
            for (var n in e) A(e, n) && a(n, e[n]);
        else {
            e = e.toLowerCase();
            var r = e.split("."),
                i = Modernizr[r[0]];
    ...
    function c() {
        var e = t.body;
        return e || (e = s(N ? "svg" : "body"), e.fake = !0), e
    }

    function f(e, n, r, i) {
        var o, a, l, d, u = "modernizr",
            f = s("div"),
            p = c();
        if (parseInt(r, 10))
            for (; r--;) l = s("div"), l.id = i ? i[r] : u + (r + 1), f.appendChild(l);
        return o = s("style"), o.type = "text/css", o.id = "s" + u, (p.fake ? p : f).appendChild(o), p.appendChild(f), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(t.createTextNode(e)), f.id = u, p.fake && (p.style.background = "", p.style.overflow = "hidden", d = _.style.overflow, _.style.overflow = "hidden", _.appendChild(p)), a = n(f, e), p.fake ? (p.parentNode.removeChild(p), _.style.overflow = d, _.offsetHeight) : f.parentNode.removeChild(f), !!a
    }
    ...
    function m(e, t, i, o) {
        ...
        for (var u, c, f, m, v, g = ["modernizr", "tspan", "samp"]; !R.style && g.length;) u = !0, R.modElem = s(g.shift()), R.style = R.modElem.style;
        for (f = e.length, c = 0; f > c; c++)
            if (m = e[c], v = R.style[m], p(m, "-") && (m = l(m)), R.style[m] !== n) {
    ...
    function g(e, t, n) {
        var i;
        for (var o in e)
            if (e[o] in t) return n === !1 ? e[o] : (i = t[e[o]], r(i, "function") ? v(i, n || t) : i);
        return !1
    }
    ...
    function y(e, t, n, i, o) {
        ...
        return r(t, "string") || r(t, "undefined") ? m(s, t, i, o) : (s = (e + " " + j.join(a + " ") + a).split(" "), g(s, t, n))
    }
    ...
    N || ! function(e, t) {
        ...
        function a(e, n, r) {
            ...
            r || (r = o(n));
            var i;
            return i = r.cache[e] ? r.cache[e].cloneNode() : b.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !i.canHaveChildren || x.test(e) || i.tagUrn ? i : r.frag.appendChild(i)
        }
        ...
        function d(e) {
            e || (e = t);
            var r = o(e);
            return !w.shivCSS || m || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), v || l(e, r), e
        }
        ...
        function c(e) {
            for (var t, n = e.attributes, r = n.length, i = e.ownerDocument.createElement(z + ":" + e.nodeName); r--;) t = n[r], t.specified && i.setAttribute(t.nodeName, t.nodeValue);
            return i.style.cssText = e.style.cssText, i
        }

        function f(e) {
            for (var t, n = e.split("{"), i = n.length, o = RegExp("(^|[\\s,>+~])(" + r().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), a = "$1" + z + "\\:$2"; i--;) t = n[i] = n[i].split("}"), t[t.length - 1] = t[t.length - 1].replace(o, a), n[i] = t.join("}");
            return n.join("{")
        }
        ...
        function h(e) {
            ...
            var r, i, a = o(e),
                s = e.namespaces,
                l = e.parentWindow;
            return !_ || e.printShived ? e : ("undefined" == typeof s[z] && s.add(z), l.attachEvent("onbeforeprint", function() {
                t();
                ...
                d = f(d.reverse().join("")), i = u(e), r = n(e, d)
        ...
        w.type += " print", w.shivPrint = h, h(t), "object" == typeof module && module.exports && (module.exports = w)
    ...
    var B = function(e, t) {
        ...
        if (e in i) {
            var o = j.length;
            for (i[e] = t, n = i[e]; o-- && !n;) i[e] = "-" + j[o] + "-" + t, n = i[e]
        }
        return "" === n && (n = !1), n
    };
    C.prefixedCSSValue = B, Modernizr.addTest("canvas", function() {
        var e = s("canvas");
        ...
        var e = s("a");
        return e.style.cssText = z.join("transition-timing-function:cubic-bezier(1,0,0,1.1); "), !!e.style.length
        ...
        var e = s("a"),
            t = s("a");
        e.style.cssText = "display: block; transform-style: preserve-3d; transform-origin: right; transform: rotateY(40deg);", t.style.cssText = "display: block; width: 9px; height: 1px; background: #000; transform-origin: right; transform: rotateY(40deg);", e.appendChild(t), _.appendChild(e);
        var n = t.getBoundingClientRect();
        return _.removeChild(e), n.width && n.width < 4
    });
    var W = {
        elem: s("modernizr")
    };
    ...
    }, 2), Modernizr.addTest("cssvalid", function() {
    ...
    Modernizr.addTest("textshadow", F("textShadow", "1px 1px")), O("#modernizr{overflow: scroll; width: 40px; height: 40px; }#" + z.join("scrollbar{width:0px} #modernizr::").split("#").slice(1).join("#") + "scrollbar{width:0px}", function(e) {
    ...
    C.testAllProps = x,
        ...
        }), Modernizr.addTest("flexbox", x("flexBasis", "1px", !0)), Modernizr.addTest("cssresize", x("resize", "both", !0)), Modernizr.addTest("scrollsnappoints", x("scrollSnapType")), Modernizr.addTest("shapes", x("shapeOutside", "content-box", !0)), Modernizr.addTest("textalignlast", x("textAlignLast")), Modernizr.addTest("csstransitions", x("transition", "all", !0)), Modernizr.addTest("userselect", x("userSelect", "none", !0)), Modernizr.addTest("target", function() {
            var t = e.document;
        ...
        }), i(), o(b), delete C.addTest, delete C.addAsyncTest;
