...
! function(a) {
    ...
    jQuery.extend(!0, b, {
        ...
        animateTheCaptions: function(a) {
            ...
            var c = a.opt,
                ...
                k = 0,
                l = d.data("index");
            if (c.layers = c.layers || new Object, c.layers[l] = c.layers[l] || d.find(".tp-caption"), c.layestatic = c.layestatic || c.c.find(".tp-static-layers").find(".tp-caption"), void 0 === c.timelines && b.createTimelineStructure(c), c.conh = c.c.height(), c.conw = c.c.width(), c.ulw = c.ul.width(), c.ulh = c.ul.height(), c.debugMode) {
            ...
            }), c.layestatic && jQuery.each(c.layestatic, function(a, d) {
                var e = jQuery(this),
                    g = e.data();
            ...
            }), c.timelines.staticlayers && jQuery.each(c.timelines.staticlayelayers, function(a, d) {
                var e = d.layer.data(),
        ...
        prepareSingleCaption: function(a) {
            ...
            if ("off" === m || d._gw < e.hideCaptionAtLimit && "on" == d.captionhidden || d._gw < e.hideAllCaptionAtLimit ? d._pw.addClass("tp-hidden-caption") : d._pw.removeClass("tp-hidden-caption"), d.layertype = "html", a.offsetx < 0 && (a.offsetx = 0), void 0 != d.thumbimage && void 0 == d.videoposter && (d.videoposter = d.thumbimage), c.find("img").length > 0) {
                ...
                o = void 0 === o ? 0 : o, p = void 0 === p ? 0 : p, "off" !== d._responsive ? ("grid" != d._ba && u ? jQuery.isNumeric(o) ? n.css({
                    ...
                    width: o,
                    height: p
                }), d._ingroup && "row" !== d._nctype && (void 0 !== o && !jQuery.isNumeric(o) && o.indexOf("%") > 0 && punchgs.TweenLite.set([d._lw, d._pw, d._mw], {
                    minWidth: o
                }), void 0 !== p && !jQuery.isNumeric(p) && p.indexOf("%") > 0 && punchgs.TweenLite.set([d._lw, d._pw, d._mw], {
                    minHeight: p
                }))
            }
        ...
        createFrameOnTimeline: function(a) {
            ...
            if (u = void 0 === u ? "forward" : u, d.hoverframeindex !== -1 && d.hoverframeindex == s && (s -= 1), n.content = new punchgs.TimelineLite({
                    ...
                    align: "normal"
                }), void 0 === f.vaid && (f.vaid = Math.round(1e5 * Math.random())), "column" === d._nctype && (f.add(punchgs.TweenLite.set(d._cbgc_man, {
                    display: "block"
            ...
            var D, E, y = g !== d.outframeindex ? q(j(), d.frames[g].to, void 0, w, l.length - 1) : void 0 !== d.frames[g].to && null === d.frames[g].to.match(/auto:auto/g) ? q(m(), d.frames[g].to, 1 == k.sdir, w, l.length - 1) : q(m(), d.frames[d.inframeindex].from, 0 == k.sdir, w, l.length - 1),
            ...
            if (0 !== g || a.fromcurrentstate ? E = r(d.frames[g].mask) : D = r(d.frames[g].mask), y.anim.ease = void 0 === d.frames[g].ease ? punchgs.Power1.easeInOut : d.frames[g].ease, void 0 !== B && (B.anim.ease = void 0 === d.frames[g].ease ? punchgs.Power1.easeInOut : d.frames[g].ease, B.speed = void 0 === d.frames[g].speed ? B.speed : d.frames[g].speed, B.anim.x = B.anim.x * k.bw || p(B.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal"), B.anim.y = B.anim.y * k.bw || p(B.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical")), void 0 !== y && (y.anim.ease = void 0 === d.frames[g].ease ? punchgs.Power1.easeInOut : d.frames[g].ease, y.speed = void 0 === d.frames[g].speed ? y.speed : d.frames[g].speed, y.anim.x = y.anim.x * k.bw || p(y.anim.x, k, d.eow, d.eoh, d.calcy, d.calcx, "horizontal"), y.anim.y = y.anim.y * k.bw || p(y.anim.y, k, d.eow, d.eoh, d.calcy, d.calcx, "vertical")), c.data("iframes") && f.add(punchgs.TweenLite.set(c.find("iframe"), {
                    autoAlpha: 1
                }), e + "+=0.001"), g === d.outframeindex && (d.frames[g].to && d.frames[g].to.match(/auto:auto/g), y.speed = void 0 === d.frames[g].speed || "inherit" === d.frames[g].speed ? d.frames[d.inframeindex].speed : d.frames[g].speed, y.anim.ease = void 0 === d.frames[g].ease || "inherit" === d.frames[g].ease ? d.frames[d.inframeindex].ease : d.frames[g].ease, y.anim.overwrite = "auto"), 0 !== g || a.fromcurrentstate) 0 === g && a.fromcurrentstate && (y.speed = B.speed);
            else {
                if (l != c) {
    ...
    var f = function(a) {
            var b = {};
            return a.firstframe = void 0 === a.firstframe ? "frame_0" : a.firstframe, a.lastframe = void 0 === a.lastframe ? "frame_999" : a.lastframe, b.id = a.caption.data("id") || a.caption.attr("id"), b.slideid = a.caption.data("slideid") || a.caption.closest(".tp-revslider-slidesli").data("index"),
